...
case $MODEL in
  mamba2)
    SIZE_ARGS="--d_model 256 --d_state 128 --n_layers 6"
    ;;
  bi_lstm)
    SIZE_ARGS="--lstm_hidden_size 256 --lstm_layers 3"
    ;;
  transformer)
    SIZE_ARGS="--d_model 256 --tf_nhead 8 --tf_layers 6 --tf_dim_feedforward 1024"
    ;;
esac
