...
with open(os.path.join(OUTPUT_DIR, 'testing_labels.pickle'), 'rb') as f:
    ours = pickle.load(f)
with open(os.path.join(DATASET_DIR, 'labels_mag_C_class4_for_eval_10y_in_11_16.pickle'), 'rb') as f:
    ref = pickle.load(f)
