...
DEFAULT_DATA_DIR = PROJECT_ROOT / "src" / "data-processing" / "safenet" / "data"
DEFAULT_SAVE_PATH = PROJECT_ROOT / "checkpoints" / "best_safenet_full_china.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_features_file", type=str, default="training_output.pickle", help="Training features pickle file (must contain eq_data + png)")
    parser.add_argument("--train_labels_file", type=str, default="training_labels.pickle", help="Training labels pickle file")
    parser.add_argument("--val_features_file", type=str, default="testing_output.pickle", help="Validation features pickle file (must contain eq_data + png)")
    parser.add_argument("--val_labels_file", type=str, default="testing_labels.pickle", help="Validation labels pickle file")
    parser.add_argument("--test_features_file", type=str, default="testing_output.pickle", help="Test features pickle file (must contain eq_data + png)")
