...
DATA_DIR     = SRC_ROOT.parent / "data" / "california"
SCRIPT_DIR   = SRC_ROOT / "data-processing" / "california"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train SafeNet on the California / CEED dataset."
    )
    ...
    parser.add_argument("--patches",     type=int,   default=64,   help="Number of spatial patches.")
    ...
    parser.add_argument("--wandb-project",  type=str, default="safenet-california")
...
def main() -> None:
    ...
    cfg = PipelineConfig(
        ...
        wandb_run_name = args.wandb_run_name or f"california-{int(time.time())}",
